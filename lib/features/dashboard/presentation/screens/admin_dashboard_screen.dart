...
class AdminDashboardScreen extends StatelessWidget {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Quedan $disponibles notebooks disponibles. Se recomienda realizar una nueva compra.',
  ...
  Widget _buildPieChartCard() {
    ...
    final int disp = mockNotebooks
        .where((n) => n.estado == 'Disponible')
        .length;
    final int rep = mockNotebooks
        .where((n) => n.estado == 'En reparación')
        .length;
              ...
              Column(
                ...
                children: [
                  _LegendItem(
                    color: Colors.green,
                    title: 'Disponibles',
                    subtitle: '$disp (${pct(disp)}%)',
                  ),
                  const SizedBox(height: 12),
                  _LegendItem(
                    color: Colors.orange,
                    title: 'En reparación',
                    subtitle: '$rep (${pct(rep)}%)',
                  ),
                  const SizedBox(height: 12),
                  _LegendItem(
                    color: Colors.blue,
                    title: 'Vendidos',
                    subtitle: '$ven (${pct(ven)}%)',
                  ),
                  const SizedBox(height: 12),
                  _LegendItem(
                    color: Colors.red,
                    title: 'Merma',
                    subtitle: '$mer (${pct(mer)}%)',
                  ),
                ],
              ),
            ],
